...
import { TenantTenantProfileService } from './tenantProfile.service';
import {
    CreateTenantProfile,
...
export class TenantProfileController {
    constructor(
        @Inject('GRPC_TENANT_SERVICE_PROFILE')
        private readonly tenantTenantProfileService: TenantTenantProfileService,
    ) {}
    ...
    @ApiEndpoint({
        summary: `Create a tenant profile`,
        details: `
## Description
Create a profile tenant within a domain using an access token. This operation is restricted to tenant accounts only.
...
`,
    ...
    @ApiBodyExample(CreateTenantProfile, {
        tenantId: 'd4d98d4c-d2f4-4d91-a6e7-2555715ce144',
        address: '123 XYZ OK ABCXYZ',
        phoneNumber: '84944236565',
        ...
        description: 'Thang no le Vo Le hoai',
        facebookUrl: 'https://facebook.com/lehoai.vo.92',
        instagramUrl: 'https://www.instagram.com/lh_7902/',
        youtubeUrl: 'https://www.youtube.com/@Killerqueen.213',
    })
    @ApiResponseExample(
        'create',
        ...
        {
            tenantProfile: {
                id: 'c33116ae-04c5-422a-a957-bd1ed6095bd2',
                tenantId: 'd4d98d4c-d2f4-4d91-a6e7-2555715ce144',
                email: 'nguyenvukhoi150402@gmail.com',
                address: '123 XYZ OK ABCXYZ',
                phoneNumber: '84944236565',
                logo: 'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.tenant/service/92533acc-9846-4f80-ba07-cf26d83720a6',
                description: 'Thang no le Vo Le hoai',
                facebookUrl: 'https://facebook.com/lehoai.vo.92',
                instagramUrl: 'https://www.instagram.com/lh_7902/',
                youtubeUrl: 'https://www.youtube.com/@Killerqueen.213',
                createdAt: '2024-05-21T10:30:42.580Z',
                updatedAt: '2024-05-21T10:30:42.580Z',
            },
        },
        '/api/tenant/profile/create',
    )
    @ApiErrorResponses('/api/tenant/profile/create', '/api/tenant/profile/create', {
        badRequest: {
            summary: 'Validation Error',
            detail: 'tenantId should not be empty, tenantId must be a UUID, address should not be empty, address must be a string, phoneNumber should not be empty, Must be VietNam Phone Number (84..), Each image must be a valid Base64 data URI., logo should not be empty, logo must be a string, description should not be empty, description must be a string, facebookUrl should not be empty, The URL must be a valid facebook.com URL (e.g., https://www.facebook.com/username)., instagramUrl should not be empty, The URL must be a valid instagram.com URL (e.g., https://www.instagram.com/username)., youtubeUrl should not be empty, The URL must be a valid youtube.com URL (e.g., https://www.youtube.com/username).',
        },
        unauthorized: [
            {
        ...
        forbidden: [
            ...
            {
                key: 'already_exists',
                summary: 'Tenant profile already exists',
    ...
    async createTenantProfile(@Req() req: Request, @Body() data: CreateTenantProfile) {
        ...
        return await this.tenantTenantProfileService.createTenantProfile({
            user: userData,
            ...data,
    ...
    @ApiEndpoint({
        ...
        details: `
## Description
Find a Tenant Profile by Id within a domain using an access token.
## Requirements
...
`,
    ...
    @ApiResponseExample(
        'read',
        'find a Tenant Profile by Id',
        {
            tenantProfile: {
                id: 'fcfbbb68-bfe9-40f9-b2b3-bb009668edd7',
                tenantId: 'd4d98d4c-d2f4-4d91-a6e7-2555715ce144',
                email: 'nguyenvukhoi150402@gmail.com',
                address: '123 XYZ OK ABCXYZ',
                phoneNumber: '84944236565',
                logo: 'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.tenant/service/5f043b14-d264-4b0d-b537-27e7910dd3f5',
                description: 'Thang no le Vo Le hoai',
                facebookUrl: 'https://facebook.com/lehoai.vo.92',
                instagramUrl: 'https://www.instagram.com/lh_7902/',
                youtubeUrl: 'https://www.youtube.com/@Killerqueen.213',
                createdAt: '2024-05-21T11:03:45.857Z',
                updatedAt: '2024-05-21T11:03:45.857Z',
            },
        },
        '/api/tenant/profile/find/d4d98d4c-d2f4-4d91-a6e7-2555715ce144',
    )
    @ApiErrorResponses(
        '/api/tenant/profile/find/:id',
        '/api/tenant/profile/find/d4d98d4c-d2f4-4d91-a6e7-2555715ce144',
        {
            badRequest: {
                summary: 'Validation Error',
    ...
    @ApiEndpoint({
        ...
        details: `
    ## Description
Update a tenant profile within a domain using an access token. This operation is restricted to tenant accounts only.
...
- **Permissions**: Requires tenant-level permissions.
    ...
    @ApiBodyExample(UpdateTenantProfile, {
        id: '6fa0fe25-acd3-4be0-9c9e-b07b2a2c9714',
        tenantId: 'd4d98d4c-d2f4-4d91-a6e7-2555715ce144',
        facebookUrl: 'https://facebook.com/khoinguyenvubs/',
    })
    @ApiResponseExample(
        'update',
        'update Tenant Profile',
        {
            tenantProfile: {
                ...
                address: '123 XYZ OK ABCXYZ',
                phoneNumber: '84944236565',
                logo: 'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.tenant/service/597e0a2d-bb08-4179-bd0a-31c57e562d63',
                description: 'Thang no le Vo Le hoai',
                facebookUrl: 'https://facebook.com/khoinguyenvubs/',
                instagramUrl: 'https://www.instagram.com/lh_7902/',
                youtubeUrl: 'https://www.youtube.com/@Killerqueen.213',
                createdAt: '2024-05-21T11:18:52.142Z',
                updatedAt: '2024-05-21T11:31:25.899Z',
            },
        },
        '/api/tenant/profile/update',
    )
    @ApiErrorResponses('/api/tenant/profile/update', '/api/tenant/profile/update', {
        badRequest: {
            summary: 'Validation Error',
            detail: 'id should not be empty, id must be a UUID, tenantId should not be empty, tenantId must be a UUID, email must be an email, Must be VietNam Phone Number (84..), Each image must be a valid Base64 data URI., The URL must be a valid facebook.com URL (e.g., https://www.facebook.com/username)., The URL must be a valid instagram.com URL (e.g., https://www.instagram.com/username)., The URL must be a valid youtube.com URL (e.g., https://www.youtube.com/username).',
        },
        unauthorized: [
            {
                key: 'token_not_verified',
    ...
    async updateTenantProfile(@Req() req: Request, @Body() updateData: UpdateTenantProfile) {
        ...
        // console.log(userData, dataCategory)
        return await this.tenantTenantProfileService.updateTenantProfile({
            user: userData,
            ...updateData,
    ...
    @ApiBearerAuth('JWT-access-token-tenant')
    @ApiEndpoint({
        summary: `Delete one Tenant Profile by Id`,
        details: `
    ## Description
    Delete a Tenant Profile by Id within a domain using an access token. This operation is restricted to tenant accounts only.
    ...
    @ApiParamExamples([
        {
            name: 'id',
            description: 'ID of Tenant Profile',
            example: '6fa0fe25-acd3-4be0-9c9e-b07b2a2c9714',
            required: true,
        },
    ])
    @ApiResponseExample(
        ...
        'delete a Tenant Profile by Id',
        {
            tenantProfile: {
                ...
                youtubeUrl: 'https://www.youtube.com/@Killerqueen.213',
                createdAt: '2024-05-21T11:18:52.142Z',
                updatedAt: '2024-05-21T11:32:15.701Z',
            },
        },
        '/api/tenant/profile/delete/6fa0fe25-acd3-4be0-9c9e-b07b2a2c9714',
    )
    @ApiErrorResponses(
        '/api/tenant/profile/delete/:id',
        '/api/tenant/profile/delete/6fa0fe25-acd3-4be0-9c9e-b07b2a2c9714',
        {
            badRequest: {
                summary: 'Validation Error',
    ...
    async deleteTenant(@Req() req: Request, @Param() data: DeleteTenantProfile) {
        const payloadToken = req['user'];
        // const header = req.headers;
        const userData = {
            email: payloadToken.email,
        ...
        // console.log(userData, dataCategory)
        return await this.tenantTenantProfileService.deleteTenantProfile({
            user: userData,
            ...data,
        } as DeleteTenantProfileRequestDTO);
    }
}
