...
export class ServicesController {
    ...
    @ApiOperation({
        summary: 'Create services of domain',
        description: `
## Use access token
## Must use tenant account`,
        ...
        examples: {
            category_1: {
                value: {
                    ...
                    price: 50000,
                    timeService: {
                        startTime: '2024-05-09T14:00:00.812Z',
                        endTime: '2024-05-09T16:00:00.812Z',
                        duration: 15,
                        breakStart: '2024-05-09T15:00:00.812Z',
                        breakEnd: '2024-05-09T15:15:00.812Z',
                    },
                    images: [
            ...
            'application/json': {
                examples: {
                    signin: {
                        ...
                        value: {
                            statusCode: 201,
                            timestamp: '2024-05-07T18:38:21.519Z',
                            path: '/api/booking/services/create',
                            message: null,
                            error: null,
                            data: {
                                images: [
                                    'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/2febf199-b4b3-417c-84a6-28da801c9d14',
                                    'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/0bc3a4b9-e1a5-4fd5-9020-69f66b36ddcc',
                                ],
    ...
    @ApiBearerAuth('JWT-access-token-tenant')
    @ApiOperation({
        summary: 'Find one services by ID',
        description: `
## Use access token
## Use id to path`,
    })
    @ApiParam({
        ...
        example: '879101c7-7397-4e57-b196-b494acb6a76b',
        required: true,
        // type: FindOne
    })
    @ApiCreatedResponse({
        description: 'Get one service successfully!!',
        content: {
            'application/json': {
                examples: {
                    signin: {
                        summary: 'Response after get one service successfully',
                        value: {
                            statusCode: 200,
                            timestamp: '2024-05-07T18:51:36.509Z',
                            path: '/api/booking/services/find/879101c7-7397-4e57-b196-b494acb6a76b',
                            message: null,
                            error: null,
                            data: {
                                images: [
    ...
    @ApiBearerAuth('JWT-access-token-tenant')
    @ApiOperation({
        summary: 'Search one services',
        description: `
## Use access token
## Use query
## By priceLower or priceHigher or name
## Default is query to all services available
            ...
            'application/json': {
                examples: {
                    signin: {
                        ...
                        value: {
                            statusCode: 200,
                            timestamp: '2024-05-08T06:14:19.416Z',
                            path: '/api/booking/services/search?priceLower=70000&priceHigher=30000&name=5678',
                            message: null,
                            error: null,
                            data: {
                                services: [
                                    {
                                        images: [''],
                                        id: 'cebe7542-5749-4a4c-99bb-ad1ec53953af',
                                        name: 'Cat toc 5678',
                                        description: 'cat toc vip pro so 1 the gioi',
                                        price: 50000,
                                        rating: 0,
