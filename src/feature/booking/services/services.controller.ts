...
export class ServicesController {
    constructor(
        @Inject('GRPC_ECOMMERCE_BOOKING_SERVICES')
    ...
    @ApiEndpoint({
        ...
        details: `
## Description
Create a Service within a domain using an access token. This operation is restricted to tenant accounts only.
...
`,
    ...
    @ApiResponseExample(
        ...
        {
            images: [
                'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/e76e6975-94fa-4036-954b-cae4cc1e32dc',
                'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/6dbcdd8c-3818-4882-8e22-6cc5cbd02740',
            ],
            id: '155a5794-5836-46af-9aa1-7fb2ba790b44',
            name: 'Cat toc',
            description: 'cat toc vip pro so 1 the gioi',
            price: 50000,
            rating: 0,
        ...
        '/api/booking/services/create',
    )
    @ApiErrorResponses('/api/booking/services/create', '/api/booking/services/create', {
        badRequest: {
            summary: 'Validation Error',
            detail: 'name should not be empty, name must be a string, description should not be empty, description must be a string, price should not be empty, price must be a positive number, timeService.startTime must be a valid time in the format HH:mm (24-hour format), timeService.startTime should not be empty, timeService.endTime should not be empty, timeService.endTime must be a valid time in the format HH:mm (24-hour format), timeService.duration should not be empty, timeService.duration must be a positive number, timeService.duration must be an integer number, timeService.breakStart should not be empty, timeService.breakStart must be a valid time in the format HH:mm (24-hour format), timeService.breakEnd should not be empty, timeService.breakEnd must be a valid time in the format HH:mm (24-hour format), Each image must be a valid Base64 data URI., images should not be empty, images must be an array ',
        },
        unauthorized: [
            {
    ...
    async createService(@Req() req: Request, @Body() data: CreateService) {
        ...
        return await this.bookingServicesService.createService({
            user: userData,
            ...data,
...
`,
    ...
    @ApiQueryExamples([
        ...
        {
            name: 'priceHigher',
            description: 'Service which is greater than priceHigher will be showed',
            required: false,
            example: 30000,
        },
        {
            name: 'name',
            description: 'Service which has name match with this will be showed',
            required: false,
            example: 'toc',
        },
    ])
    @ApiResponseExample(
        ...
        '/api/booking/services/search?priceLower=70000&priceHigher=30000&name=toc',
    )
    @ApiErrorResponses(
        '/api/booking/services/search?priceLower=&priceHigher=&name=',
        '/api/booking/services/search?priceLower=70000&priceHigher=30000&name=toc',
        {
            badRequest: {
                summary: 'Validation Error',
                detail: 'priceLower must be a positive number, priceHigher must be a positive number',
            },
    ...
    @ApiEndpoint({
        ...
        details: `
## Description
Delete a Service by Id within a domain using an access token. This operation is restricted to tenant accounts only.
...
- **Permissions**: Requires tenant-level and user-level permissions.
    ...
    @ApiResponseExample(
        ...
        '/api/booking/services/delete/e762a42c-2a02-4ab6-a29c-75ecddb53b74',
    )
    @ApiErrorResponses(
        '/api/booking/services/delete/:id',
        '/api/booking/services/delete/e762a42c-2a02-4ab6-a29c-75ecddb53b73',
        {
            badRequest: {
                summary: 'Validation Error',
                detail: 'id must be a UUID',
    ...
    @ApiEndpoint({
        ...
        details: `
    ## Description
Update a Service within a domain using an access token. This operation is restricted to tenant accounts only.
...
- **Permissions**: Requires tenant-level permissions.
    ...
    @ApiResponseExample(
        ...
        {
            images: [
                'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/33bf8342-26cb-4b9b-b068-17fbaa2deee5',
                'https://dpbostudfzvnyulolxqg.supabase.co/storage/v1/object/public/datn.serviceBooking/service/fcec3e32-08ec-4001-92fd-32f3a1682d89',
            ],
            id: 'e762a42c-2a02-4ab6-a29c-75ecddb53b74',
            name: 'Cat toc',
            description: 'cat toc di ma pls',
        ...
        '/api/booking/servics/update',
    )
    @ApiErrorResponses('/api/booking/servics/update', '/api/booking/servics/update', {
        badRequest: {
            summary: 'Validation Error',
            detail: 'id should not be empty, id must be a UUID, name should not be empty, name must be a string, description should not be empty, description must be a string, price should not be empty, price must be a positive number, timeService.startTime must be a valid time in the format HH:mm (24-hour format), timeService.startTime should not be empty, timeService.endTime should not be empty, timeService.endTime must be a valid time in the format HH:mm (24-hour format), timeService.duration should not be empty, timeService.duration must be a positive number, timeService.duration must be an integer number, timeService.breakStart should not be empty, timeService.breakStart must be a valid time in the format HH:mm (24-hour format), timeService.breakEnd should not be empty, timeService.breakEnd must be a valid time in the format HH:mm (24-hour format), Each image must be a valid Base64 data URI., images should not be empty, images must be an array',
        },
        unauthorized: [
            {
                key: 'token_not_verified',
